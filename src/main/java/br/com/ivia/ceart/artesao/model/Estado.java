...
@Entity
@Table(name="estado",schema="corporativo")
@JsonInclude(Include.NON_NULL)
@SequenceGenerator(name="seq_estado",sequenceName="corporativo.estado_id_seq",allocationSize=1)
@Getter @Setter @NoArgsConstructor @ToString @EqualsAndHashCode(callSuper=false)
public class Estado extends BaseModel{

	private static final long serialVersionUID = 1876293720833649049L;
