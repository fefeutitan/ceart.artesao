...
@Entity
@Table(name="bairro",schema="corporativo")
@JsonInclude(Include.NON_NULL)
@SequenceGenerator(name="seq_bairro",sequenceName="corporativo.bairro_id_seq",allocationSize=1)
@Getter @Setter @NoArgsConstructor @ToString @EqualsAndHashCode(callSuper=false)
public class Bairro extends BaseModel{

	private static final long serialVersionUID = 5991018345343042413L;
